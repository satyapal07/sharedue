...
// All tints of the app's own warm palette — no greens, blues, or reds
// Lightest amber → warm honey → tan → warm neutral dark
const THEME: Record<ExpenseCategory, Theme> = {
  food:          { bg: "#F5E6D0", fg: "#8B4820" },
  entertainment: { bg: "#F2E0C0", fg: "#8A5E10" },
  utilities:     { bg: "#EEE0B0", fg: "#705E10" },
  shopping:      { bg: "#EDD8CC", fg: "#7A3820" },
  fitness:       { bg: "#EAD4CC", fg: "#6E2820" },
  general:       { bg: "#E8E2D8", fg: "#48382A" },
  housing:       { bg: "#E5E0D5", fg: "#403828" },
  outdoors:      { bg: "#E0DDD0", fg: "#484028" },
  transport:     { bg: "#DDD8D0", fg: "#383430" },
  travel:        { bg: "#DAD5CE", fg: "#30302A" },
  settlement:    { bg: "#D8D4CC", fg: "#282828" },
};
...
export default function CategoryIcon({
  ...
  const icon = size === "lg" ? "w-7 h-7" : "w-[22px] h-[22px]";
  ...
  const icons: Record<ExpenseCategory, React.ReactNode> = {
    ...
    // Barbell — filled rects render clearly at any size
    fitness: (
      <svg className={icon} viewBox="0 0 24 24" fill="currentColor">
        <rect x="1.5" y="10" width="2" height="4" rx="1"/>
        <rect x="3.5" y="7.5" width="2.5" height="9" rx="1"/>
