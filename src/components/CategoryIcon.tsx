...
const icons: Record<ExpenseCategory, React.ReactNode> = {
  ...
  // Car (side profile with roof + wheels) — replaces the van/truck
  transport: (
    <svg className="w-5 h-5 text-[#1A1510]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  // Airplane — for flights, holidays abroad
  travel: (
    <svg className="w-5 h-5 text-[#1A1510]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  // Light bulb — electricity, internet, bills
  utilities: (
    <svg className="w-5 h-5 text-[#1A1510]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
