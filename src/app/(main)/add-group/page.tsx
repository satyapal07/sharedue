        ...
        <div>
          ...
          {groupName.trim() && (
            <button
              type="button"
              onClick={() => {}}
              className="mt-2 flex items-center gap-1.5 bg-[#EDE8E1] rounded-full px-3 py-1.5 w-fit"
            >
              <CategoryIcon category={category} />
              <span className="text-[12px] font-semibold text-[#1A1510] capitalize">{category}</span>
            </button>
          )}
        </div>
